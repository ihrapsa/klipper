#ifndef __ATSAMD_T5UID1_SERIAL_PINS_H
#define __ATSAMD_T5UID1_SERIAL_PINS_H
...
// RX definitions
  ...
  #if CONFIG_ATSAMD21_SERIAL_RX_PA24 || CONFIG_ATSAMD21_SERIAL_TX_PA24 || CONFIG_USBSERIAL
    #error "The RX pin selected for the T5UID1 screen is already used"
  #endif
  ...
  #if CONFIG_ATSAMD21_SERIAL_RX_PA25 || CONFIG_ATSAMD21_SERIAL_TX_PA25 || CONFIG_USBSERIAL
    #error "The RX pin selected for the T5UID1 screen is already used"
  #endif
