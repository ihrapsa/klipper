...
void
t5uid1_SERCOMx_DRE_Handler(void)
{
    uint8_t data;
...
void
t5uid1_SERCOMx_RXC_Handler(void)
{
...
t5uid1_init(uint32_t baud)
{
    ...
    armcm_enable_irq(t5uid1_SERCOMx_DRE_Handler, SERCOMx_0_IRQn, 0);
    armcm_enable_irq(t5uid1_SERCOMx_RXC_Handler, SERCOMx_2_IRQn, 0);
}
